...
def main():
    ...
    for board_name in board_names:
        ...
        # Peripherals
        if "ext_leds" in board.soc_capabilities:
            soc_kwargs.update(with_ext_led_chaser=True)
        ...
        if "framebuffer" in board.soc_capabilities:
        	...
        	video_framebuffer_base=0x41000000,  # Place framebuffer in SDRAM
        	video_framebuffer_use_external=True,
        	video_framebuffer_width=160,
        	video_framebuffer_height=120,
        	video_framebuffer_bits_per_pixel=8
    	)
        ...
        if "rgb_led" in board.soc_capabilities:
            soc.add_rgb_led()
        if "ext_led" in board.soc_capabilities:
            soc.add_ext_led()
